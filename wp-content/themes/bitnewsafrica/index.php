...
<html lang="en">
<head>
	<title>Welcome | This is a News site for Blockchain News around Africa</title>
	...
	<link href="<?php echo get_bloginfo('template_directory'); ?>/plugin-frameworks/bootstrap.css" rel="stylesheet">
	
	<link href="<?php echo get_bloginfo('template_directory'); ?>/fonts/ionicons.css" rel="stylesheet">
	
		
	<link href="<?php echo get_bloginfo('template_directory'); ?>/common/styles.css" rel="stylesheet">
...
<body>
	...
	<header>
		...
		<div class="container">
			<a class="logo" href="<?php echo get_bloginfo('template_directory'); ?>/index.html"><img src="<?php echo get_bloginfo('template_directory'); ?>/images/logo-black.png" alt="Logo"></a>
			...
			<ul class="main-menu" id="main-menu">
				...
				<li class="drop-down"><a href="<?php echo get_bloginfo('template_directory'); ?>/03_single-post.html">GUIDES & ANALYTICS<i class="ion-arrow-down-b"></i></a>
			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-8">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<img src="<?php echo get_bloginfo('template_directory'); ?>/images/recent-news-1-600x450.jpg" alt="">
						...
						<div class="col-sm-6">
							<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
								<div class="wh-100x abs-tlr"><img src="<?php echo get_bloginfo('template_directory'); ?>/images/polular-1-100x100.jpg" alt=""></div>
							...
							<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
								<div class="wh-100x abs-tlr"><img src="<?php echo get_bloginfo('template_directory'); ?>/images/polular-2-100x100.jpg" alt=""></div>
								<div class="ml-120 min-h-100x">
									<h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
									<h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
								</div>
							...
							<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
								<div class="wh-100x abs-tlr"><img src="<?php echo get_bloginfo('template_directory'); ?>/images/polular-3-100x100.jpg" alt=""></div>
								<div class="ml-120 min-h-100x">
									<h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
									<h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
								</div>
							...
							<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
								<div class="wh-100x abs-tlr"><img src="<?php echo get_bloginfo('template_directory'); ?>/images/polular-4-100x100.jpg" alt=""></div>
								<div class="ml-120 min-h-100x">
									<h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
									<h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
								</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<img src="<?php echo get_bloginfo('template_directory'); ?>/images/crypto-news-6-600x450.jpg" alt="">
							<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br/>Crypto vs.Stock</b></a></h4>
						...
						<div class="col-sm-6">
							<img src="<?php echo get_bloginfo('template_directory'); ?>/images/crypto-news-5-600x450.jpg" alt="">
							<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br/>Crypto vs.Stock</b></a></h4>
							<ul class="list-li-mr-20 pt-10 mb-30">
								<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
								Jan 25, 2018</li>
						...
						<div class="col-sm-6">
							<img src="<?php echo get_bloginfo('template_directory'); ?>/images/crypto-news-4-600x450.jpg" alt="">
							<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br/>Crypto vs.Stock</b></a></h4>
							<ul class="list-li-mr-20 pt-10 mb-30">
								<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
								Jan 25, 2018</li>
						...
						<div class="col-sm-6">
							<img src="<?php echo get_bloginfo('template_directory'); ?>/images/crypto-news-3-600x450.jpg" alt="">
							<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br/>Crypto vs.Stock</b></a></h4>
							<ul class="list-li-mr-20 pt-10 mb-30">
								<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
								Jan 25, 2018</li>
						...
						<div class="col-sm-6">
							<img src="<?php echo get_bloginfo('template_directory'); ?>/images/crypto-news-2-600x450.jpg" alt="">
							<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br/>Crypto vs.Stock</b></a></h4>
							<ul class="list-li-mr-20 pt-10 mb-30">
								<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
								Jan 25, 2018</li>
						...
						<div class="col-sm-6">
							<img src="<?php echo get_bloginfo('template_directory'); ?>/images/crypto-news-1-600x450.jpg" alt="">
				...
				<div class="col-md-6 col-lg-4">
					<div class="pl-20 pl-md-0">
						...
						<div class="mtb-50 pos-relative">
							<img src="<?php echo get_bloginfo('template_directory'); ?>/images/banner-1-600x450.jpg" alt="">
		...
		<div class="container">
			<div class="pt-50 pb-20 pos-relative">
				<div class="abs-tblr pt-50 z--1 text-center">
					<div class="h-80 pos-relative"><img class="opacty-1 h-100 w-auto" src="<?php echo get_bloginfo('template_directory'); ?>/images/map.png" alt=""></div>
				</div>
				<div class="row">
				
					<div class="col-sm-4">
						<div class="mb-30">
							<a href="#"><img src="<?php echo get_bloginfo('template_directory'); ?>/images/logo-white.png"></a>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="ion-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlibb</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="<?php echo get_bloginfo('template_directory'); ?>/plugin-frameworks/jquery-3.2.1.min.js"></script>
	
	<script src="<?php echo get_bloginfo('template_directory'); ?>/plugin-frameworks/tether.min.js"></script>
	
	<script src="<?php echo get_bloginfo('template_directory'); ?>/plugin-frameworks/bootstrap.js"></script>
	
	<script src="<?php echo get_bloginfo('template_directory'); ?>/common/scripts.js"></script>
